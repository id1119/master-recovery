...
COMPOSE_FILE = "compose.network.yml"
...
def parse_ps_output(stdout):
    ...
    for entry in entries:
        ...
        started = parse_time(inspect.get(container_id, {}).get("started_at"))
        ...
        nodes.append({
            ...
            "restart_count": inspect.get(container_id, {}).get("restart_count"),
            "memory": stats.get(container_id, {}).get("memory"),
        })
