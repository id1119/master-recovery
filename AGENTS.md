...
1. `MASTER_PROMPT.md`
2. `GUARDIAN_ROTATION.md` (protocol-v3 Guardian Rotation only)
3. `PROTOCOL.md`
4. `SECURITY.md`
5. `ENVELOPE_SPEC.md` (owner-side artifact format — design draft, not implemented; protocol wins on any conflict)
6. `METADATA_RESISTANCE.md`
7. `ARCHITECTURE.md`
8. `DEMO.md`
9. `README.md`
